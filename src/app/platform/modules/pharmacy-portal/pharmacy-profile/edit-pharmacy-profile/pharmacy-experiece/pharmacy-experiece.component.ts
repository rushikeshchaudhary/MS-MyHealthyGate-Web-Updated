...
@Component({
  selector: 'app-pharmacy-experiece',
  templateUrl: './pharmacy-experiece.component.html',
  styleUrls: ['./pharmacy-experiece.component.css']
})
export class PharmacyExperieceComponent implements OnInit {
