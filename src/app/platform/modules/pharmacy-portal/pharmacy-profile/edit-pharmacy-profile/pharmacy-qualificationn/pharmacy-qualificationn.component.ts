...
@Component({
  selector: 'app-pharmacy-qualificationn',
  templateUrl: './pharmacy-qualificationn.component.html',
  styleUrls: ['./pharmacy-qualificationn.component.css']
})
export class PharmacyQualificationnComponent implements OnInit {
