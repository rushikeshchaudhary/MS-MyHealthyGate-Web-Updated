...
@Component({
  selector: 'app-pharmacy-award',
  templateUrl: './pharmacy-award.component.html',
  styleUrls: ['./pharmacy-award.component.css']
})
export class PharmacyAwardComponent implements OnInit {
