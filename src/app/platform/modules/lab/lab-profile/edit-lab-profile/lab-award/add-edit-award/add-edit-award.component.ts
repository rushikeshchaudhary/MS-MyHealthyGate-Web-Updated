...
@Component({
  selector: 'app-add-edit-award',
  templateUrl: './add-edit-award.component.html',
  styleUrls: ['./add-edit-award.component.css']
})
export class AddEditAwardComponent implements OnInit {
  ...
  constructor(
    private dialogModalRef: MatDialogRef<AddEditAwardComponent>,
