...
@Component({
  selector: 'app-lab-qualificationn',
  templateUrl: './lab-qualificationn.component.html',
  styleUrls: ['./lab-qualificationn.component.css']
})
export class LabQualificationnComponent implements OnInit {
