...
import { UserDocumentModel } from "../../client-portal/clients-details/client.model";
import { LabDocumentModalComponent } from "./lab-document-modal/lab-document-modal.component";
...
@Component({
  ...
  styleUrls: ["./lab-document.component.css"],
})
export class LabDocumentComponent implements OnInit {
  ...
  downoladUserDocument = (value: UserDocumentModel) => {
