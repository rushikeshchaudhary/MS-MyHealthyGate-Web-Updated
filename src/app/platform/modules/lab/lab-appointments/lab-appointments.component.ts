...
export class LabAppointmentsComponent implements OnInit {
  ...
  appointmentMode: any = ["Home Visit","Face to Face"];
  ...
  @Input()isLoadDashboardAppointment:boolean=false;
  ...
  // toDate;
  // fromDate;
  // labAppointmentList: Array<any>;
  // approvedAppointmentList: Array<any>;
  // patientList: any[] = [];
  // isCalendarIconFilter: boolean = false;
  ...
  // filterMasterSearchPatients: any = [];
  // requestData: any;
  // approvedAppointmentColumns: Array<any> = [
  //   {
  ...
  //       if (this.isCalendarIconFilter) {
  //         this.filteredPatient = { patientId: this.patientId }
  //         this.filterMasterSearchPatients = this.patientList.filter(x => x.patientId == this.patientId);
  //         this.requestData.patientIds = this.patientId;
  //         this.appointmentFormGroup.patchValue({ searchPatient: this.filterMasterSearchPatients[0].nameWithMRN });
  //       }
  //   });
  // }

  // setIntialValues() {
  //   this.appForm.appStatus.setValue(["Home Visit", "Face to Face", "Online"]);
  //   this.getAppointmentList("INVITATION_ACCEPTED");


  //     if (this.monthstatus != null) {
  //       var date = new Date();
  //       this.appForm.rangeStartDate.setValue(
  //         new Date(date.getFullYear(), date.getMonth() - 1, 1)
  //       );
  //       this.appForm.rangeEndDate.setValue(
  //         new Date(date.getFullYear(), date.getMonth(), 0)
  //       );
  //     } else {
  //       var date = new Date();
  ...
  //     //this.getAppointmentList("INVITATION_ACCEPTED");
  //   } else if (event == 1) {
  //     console.log("INVITATION_REJECTED")

  //     //this.getAppointmentList("INVITATION_REJECTED");
  //   } else if (event == 2) {
  //     console.log("Invited")

  //     //this.getAppointmentList("Invited");
  //   }
  // };
  // applyStartDateFilter(event: MatDatepickerInputEvent<Date>) {
  //   this.appForm.rangeStartDate.setValue(new Date(event.value));
  //   this.getAppointmentList("");
  // }
  // applyEndDateFilter(event: MatDatepickerInputEvent<Date>) {
  //   this.appForm.rangeEndDate.setValue(new Date(event.value));
  //   this.getAppointmentList("");
  // }
  // clearFilters() {
  ...
  //   console.log(this.appForm.appStatus.value);
  //   let bookingMode = this.appForm.appStatus.value;


  //   // this.labService
  //   //   .GetFilterLabAppointmentByLabId(
  //   //     this.labData.id,
  //   //     status,
  //   //     null,
  //   //     null,
  //   //     this.labAppointmentFilter,
  //   //     bookingMode
  //   //   )
  //   //   .subscribe((res) => {
  //   //     this.labAppointmentList = res.data;
  //   //     this.labAppointmentList = this.labAppointmentList.map((x) => {
  //   //       x.startDateTime =
  //   //         format(x.startDateTime, 'MM/dd/yyyy') +
  //   //         " (" +
  //   //         format(x.startDateTime, 'h:mm a') +
  ...
  //   //       return x;
  //   //     });
  //   //     this.metaData = res.meta || new Metadata();
  //   //     this.metaData.pageSizeOptions = [5, 10, 25, 50, 100];
  //   //   });
  ...
  //   const filterModal = {
  //     locationIds: "101",
  //     fromDate: format(this.appForm.rangeStartDate.value, "yyyy-MM-dd").toString(),
  //     toDate: format(this.appForm.rangeEndDate.value, "yyyy-MM-dd").toString(),
  //     staffIds: this.labData.id,
  //     patientIds: "",
  //   };
  //   this.schedulerService.getListData(filterModal).subscribe((res: any) => {
  //     this.labAppointmentList = res.data;
  //         this.labAppointmentList = this.labAppointmentList.map((x) => {
  //           x.startDateTime =
  //             format(x.startDateTime, 'MM/dd/yyyy') +
  ...
  // patientStatusChangeHandler = (e) => {
  //   this.filteredPatient = e;
  //   this.requestData.patientIds = this.filteredPatient.patientId && this.filteredPatient.patientId !== undefined && this.filteredPatient != null ? this.filteredPatient.patientId : 0;
  //   this.applyFilter();
  // }
  ...
  //     this.requestData.sortColumn,
  //     this.requestData.sortOrder,
  //     this.appForm.appStatus.value,
  //     this.appForm.rangeStartDate.value,
  //     this.appForm.rangeEndDate.value,
  //     this.requestData.searchText
  //   );

  //   this.getAppointmentList(null);
  // }
  ...
  //       : "";
  //   this.requestData.searchText = searchText;
  //   this.requestData.patientIds = this.filteredPatient != null ? this.filteredPatient.patientId : 0;
  // }
