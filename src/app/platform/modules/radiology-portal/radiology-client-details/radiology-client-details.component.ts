...
@Component({
  selector: 'app-radiology-client-details',
  templateUrl: './radiology-client-details.component.html',
  styleUrls: ['./radiology-client-details.component.css']
})
export class RadiologyClientDetailsComponent implements OnInit {
