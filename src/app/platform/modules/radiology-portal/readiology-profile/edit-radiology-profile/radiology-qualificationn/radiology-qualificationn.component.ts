...
@Component({
  selector: 'app-radiology-qualificationn',
  templateUrl: './radiology-qualificationn.component.html',
  styleUrls: ['./radiology-qualificationn.component.css']
})
export class RadiologyQualificationnComponent implements OnInit {
