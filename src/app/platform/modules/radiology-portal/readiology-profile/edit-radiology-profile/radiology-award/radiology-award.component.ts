...
import { AddEditAwardComponent } from "./add-edit-award/add-edit-award.component";
import { MatDialog } from "@angular/material/dialog";

@Component({
  selector: 'app-radiology-award',
  templateUrl: './radiology-award.component.html',
  styleUrls: ['./radiology-award.component.css']
})
export class RadiologyAwardComponent implements OnInit {
  ...
  createModal = (type:any, qualificationData:any) => {
    ...
    let documentModal;
    documentModal = this.dialogModal.open(AddEditAwardComponent, {
      data: staffData,
    });
