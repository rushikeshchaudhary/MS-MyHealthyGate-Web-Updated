...
@Component({
  selector: 'app-radiology-experience',
  templateUrl: './radiology-experience.component.html',
  styleUrls: ['./radiology-experience.component.css']
})
export class RadiologyExperienceComponent implements OnInit {
