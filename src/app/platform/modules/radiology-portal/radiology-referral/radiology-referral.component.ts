...
import { LabTestDownloadPatientComponent } from "../../client-portal/lab-test-download-patient/lab-test-download-patient.component";
...
import { RadiologyReferralFileUploadComponent } from "../../agency-portal/radiology-referral-file-upload/radiology-referral-file-upload.component";


@Component({
  selector: "app-radiology-referral",
  templateUrl: "./radiology-referral.component.html",
  styleUrls: ["./radiology-referral.component.css"],
})
export class RadiologyReferralComponent implements OnInit {
  ...
  openFileDownloadModal(data: any) {
    const modalPopup = this.dialogModal.open(RadiologyReferralFileUploadComponent, {
      hasBackdrop: true,
      width: "70%",
      height: "60%",
      data: data,
