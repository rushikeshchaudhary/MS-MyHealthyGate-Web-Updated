...
// import { ManageQuestionnaireModel, ProviderQuestionnaireModel } from '../providerquestionnaire.model';

// @Component({
//   selector: 'app-add-managequestionnaire',
//   templateUrl: './add-managequestionnaire.component.html',
//   styleUrls: ['./add-managequestionnaire.component.css'] 
// })
// export class AddManagequestionnairesComponent implements OnInit {
//   //@Output() handleTabChange: EventEmitter<any> = new EventEmitter<any>();
//   payerModel: ManageQuestionnaireModel;
//   payerForm: FormGroup;
//   masterCountry: any[];
//   masterState: any[];
...
//   payerId: number;
//   printFormats: any[];
//   formValues:ManageQuestionnaireModel;
...
//     this.payerModel = new ManageQuestionnaireModel();
...
//       questionnnaireName: [this.payerModel.QuestionnnaireName],
...
//     this.payersService.getQuestionnairedataById(this.payerId).subscribe((response: ResponseModel) => {
...
//   goBack() {
//     this.route.navigate(["/web/assign-questionnaire/questionnairelist"]);
//   }
...
//       this.formValues.QuestionnareId=this.payerId;
//       this.submitted = true;
//       this.payersService.addQuestionnaire(this.formValues).subscribe((response: ResponseModel) => {
