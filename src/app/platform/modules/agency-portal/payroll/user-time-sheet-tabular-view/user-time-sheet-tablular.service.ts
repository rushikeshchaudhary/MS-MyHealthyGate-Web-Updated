...
export class UserTimeSheetTabularViewService {
    ...
    submitTimeSheetStatusURL = 'StaffTimesheet/UpdateUserTimesheetStatus';
    ...
    submitTimeSheetStatus(data: any) {
        return this.commonService.patch(this.submitTimeSheetStatusURL, data);
    }
