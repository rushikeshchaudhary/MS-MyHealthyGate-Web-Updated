    ...
    this.commonService.getProfileUpdated(this.staffId).subscribe((res) => {
      ...
      if (res) {
        if (!res.data.staffExperiences) {
          matTabLabels[0].children[1].children[0].classList.add(
            "mat-tab-text-color"
          );
        } else {
          matTabLabels[0].children[1].children[0].classList.remove(
            "mat-tab-text-color"
          );
        }
        if (!res.data.staffQualifications) {
          matTabLabels[0].children[2].children[0].classList.add(
            "mat-tab-text-color"
          );
        } else {
          matTabLabels[0].children[2].children[0].classList.remove(
            "mat-tab-text-color"
          );
        }
        if (!res.data.staffAwards) {
          matTabLabels[0].children[3].children[0].classList.add(
            "mat-tab-text-color"
          );
        } else {
          matTabLabels[0].children[3].children[0].classList.remove(
            "mat-tab-text-color"
          );
        }
